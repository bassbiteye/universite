...
if ($isSuccess) {
    ...
    $type = new Type($type, $montant);

    var_dump($type);
    $serv->editType($type, $id);
    ...
    <div class="w3-main" style="margin-left:300px">
        ...
        <div class="w3-container w3-padding-large ">
            ...
            <form action="" target="_blank" method="post">
                <input type="text" name="id_type" class="form-control" placeholder="" hidden value="<?php echo $_GET['id_type']; ?>">

                <div class="w3-section">
                    <label>type</label>
                    <input class="w3-input w3-border" type="text" name="type" value="<?php echo $_GET['libelle']; ?>">
                    <p class="comments"><?php echo $typeError; ?></p>
                </div>

                <div class="w3-section">
                    <label>montant</label>
                    <input class="w3-input w3-border" type="number" name="montant" value="<?php echo $_GET['montant']; ?>">
